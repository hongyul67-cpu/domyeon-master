...
/* ═══ Ⅰ. 제도의 규격 ═══ */
{u:'Ⅱ-1. 제도의 규격(KS)', t:'도면은 말없이 전달하는 지시서',
...
{u:'Ⅱ-1. 제도의 규격(KS)', t:'표준에도 층이 있다', fig:'std',
...
{u:'Ⅱ-1. 제도의 규격(KS)', t:'나라마다 부르는 이름이 다르다', fig:'stdTable',
...
{u:'Ⅱ-1. 제도의 규격(KS)', t:'KS 는 부문으로 나뉜다', fig:'ksTable',
...
{u:'Ⅱ-1. 제도의 규격(KS)', t:'제도 통칙 — KS A 0005',
...
/* ═══ Ⅱ. 도면의 크기 ═══ */
{u:'Ⅱ-2. 도면의 크기', t:'반으로 접으면 다음 크기', fig:'papers',
...
{u:'Ⅱ-2. 도면의 크기', t:'A0 은 841 × 1189 · 넓이 약 1m²',
...
{u:'Ⅱ-2. 도면의 크기', t:'용지 크기와 제도 영역', fig:'sizeTable',
...
{u:'Ⅱ-2. 도면의 크기', t:'용지가 크면 구역도 많아진다',
...
{u:'Ⅱ-2. 도면의 크기', t:'큰 도면은 A4 크기로 접어 보관한다',
...
/* ═══ Ⅲ. 도면의 양식 ═══ */
{u:'Ⅱ-3. 도면의 양식·표제란', t:'정해진 자리에 정해진 것을 그린다', fig:'form5',
...
{u:'Ⅱ-3. 도면의 양식·표제란', t:'윤곽선 — 왼쪽만 20mm', fig:'frame',
...
{u:'Ⅱ-3. 도면의 양식·표제란', t:'표제란 — 오른쪽 아래 구석',
...
{u:'Ⅱ-3. 도면의 양식·표제란', t:'중심 마크 — 네 곳에 짧게',
...
{u:'Ⅱ-3. 도면의 양식·표제란', t:'구역 표시 — I 와 O 는 쓰지 않는다', fig:'zone',
...
{u:'Ⅱ-3. 도면의 양식·표제란', t:'재단 마크 — 자를 자리 표시',
...
/* ═══ Ⅳ. 척도 ═══ */
{u:'Ⅱ-4. 척도', t:'척도 A : B — 앞이 도면, 뒤가 실물', fig:'scale3',
...
{u:'Ⅱ-4. 척도', t:'★ 척도를 바꿔도 치수는 실제 치수', fig:'scaleDim',
...
/* ── 합본용 꼬리 ──────────────────────────────────────────────
   2026-09-08, 이 원고는 '기초 제도 마스터 아카데미'(domyeon-master) 안으로 들어왔다.
   덮어쓰지 않고 lesson.js 의 덱 앞에 붙인다 — 수업 순서가 양식·척도 → 선 → 치수 → 기계요소 다.
   그림 키(std·papers·frame…)는 lesson.js 의 lm* 키와 겹치지 않는다. */
window.LESSON  = LESSON.concat(window.LESSON || []);
window.LESSFIG = Object.assign({}, window.LESSFIG || {}, FIG);
})();
